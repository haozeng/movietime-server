...
curl -H "Authorization: Bearer b67046dc860dd180db4b85a24b4268a7fde85fc0cffb4d01986bc6b34359d5b1" -X GET localhost:3000/purchase_orders
...
ToDoList:
icons for purchase flows
logo
launch screen
1, api to reset password
2, view in server side to handle password stuff
3, movie code rendering and regal/cinemarks code format research
6, forget password UI in IOS

IOS todo:
clean up my sign-in/sign-up branch
logout button and maybe sign in with Facebook
payment profiles selection button and able to select
user without payment profile will crash in brands index page when fetching